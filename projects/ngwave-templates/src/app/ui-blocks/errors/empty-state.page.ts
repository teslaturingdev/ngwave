...
@Component({
  ...
  imports: [NwButtonComponent, NwCardComponent],
  template: `
      ...
      <div class="w-full max-w-xl space-y-6">
        <nw-card header="Projects">
          <div class="flex flex-col items-center text-center py-10">
            <span
              class="inline-flex h-14 w-14 items-center justify-center rounded-full bg-surface-100 text-surface-400 text-2xl"
              >◌</span
            >
