...
import { NwButtonComponent, NwCheckboxComponent, NwInputTextComponent, NwOverlayPanelComponent, NwTagComponent } from '@ngwave/ui';
...
const ALL_SUGGESTIONS: Suggestion[] = [
  { icon: '📄', label: 'Q3 Expansion Proposal', category: 'Documents' },
  { icon: '📄', label: 'Q3 Marketing Budget', category: 'Documents' },
  { icon: '👤', label: 'Quinn Alvarez', category: 'People' },
  { icon: '📁', label: 'Quality Assurance', category: 'Projects' },
  { icon: '💬', label: 'Quick sync notes', category: 'Messages' },
];
